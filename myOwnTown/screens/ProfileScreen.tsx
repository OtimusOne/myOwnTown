  ...
  interpretError = string => {
    switch (string) {
      ...
      case 'auth/weak-password':
        this.setState({ isPasswordValid: false, isLoading: false });
      ...
      case 'auth/wrong-password':
        ...
        break;
      default:
        alert('The error might be ours, or you do not have internet connection. Contact us');
    }
  };
            ...
            >
              ...
              <View style={styles.formContainer}>
                ...
                <Input
                  ...
                  ref={input => {
                    this.passwordInput.current = input;
                  }}
                  onSubmitEditing={() =>
                  ...
                  errorMessage={isPasswordValid ? null : 'Password is weak, try another one'}
                />
                {isSignUpPage && (
                  <Input
                    leftIcon={
                    ...
                    ref={input => {
                      this.confirmationInput.current = input;
                    }}
                    /* eslint-disable-next-line no-shadow */
